    ...
    public sealed partial class Shell : UserControl
    {
        ...
        public Shell()
        {
            ...
            NavigationItems = new[]
            {
                ...
                new SampleEntry(RedditBrowserOverviewItem, typeof(PuttingThingsTogetherPage), "将东西集中放置"),
                new SampleEntry(ViewModelsSetupItem, typeof(SettingUpTheViewModelsPage), "设置视图模型"),
